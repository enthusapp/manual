...
정상적으로 수신될 경우 아래와 같이 날짜와 시간이 표시됩니ㅏㄷ.
...
테스테용 시료는 pixel 은 20 개 이상 표현이 가능해야 합니다.

예를 들어 LSB0036-20W20 의 시료를 사용합니다.

<img src="img/mfplayer1/lsb0036.png" width="1000" />

시료를 CH1 ~ CH8 에 연결합니다.

`Stop` 버튼을 누르고 스케줄 리스트 중 rainbow 로 표시된 스케줄을 선택합니다.
